...
<?php
    ...
    $sql = "INSERT INTO student (user_id, stu_fname, stu_lname, stu_gender, stu_birth, 
            fac_id, branch_id, stu_phone,  stu_email, stu_address, stu_gpa, ra_id ,advicer) 
            VALUES ('$user_id', '$fname', '$lname', '$gender', '$birth', '$faculty', '$branch', '$phone', '$email', '$address', '0','4' ,'$advicer')";
